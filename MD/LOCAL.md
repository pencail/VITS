...
9. Put your voice data under corresponding directories, see [DATA.MD](./DATA_EN.MD) for detailed different uploading options.
   ### Short audios
   1. Prepare your data according to [DATA.MD](./DATA_EN.MD) as a single `.zip` file;  
   ...
   ### Long audios
   1. Name your audio files according to [DATA.MD](./DATA_EN.MD);
   2. Put your renamed audio files under directory `./raw_audio/`
   
   ### Videos
   1. Name your video files according to [DATA.MD](./DATA_EN.MD);
